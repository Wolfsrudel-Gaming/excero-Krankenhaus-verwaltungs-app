...
async function viewEinstellungen() {
  ...
  const d = await api('/excero/api/web/einstellungen');
  ...
  document.getElementById('smtp-save').addEventListener('click', async () => {
    try {
      await api('/excero/api/web/einstellungen/smtp', { method: 'PUT', body: {
  ...
  document.getElementById('hd-save').addEventListener('click', async () => {
    try {
      await api('/excero/api/web/einstellungen/hidrive', { method: 'PUT', body: {
  ...
  document.getElementById('hd-test').addEventListener('click', async () => {
    try {
      await api('/excero/api/web/hidrive/list?pfad=/');
